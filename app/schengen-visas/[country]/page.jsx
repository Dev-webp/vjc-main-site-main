...
const metaData = {
  ...
  bulgaria: {
    title: "Bulgaria Schengen Visa | VJC Overseas",
  ...
  denmark: {
    title: "Denmark Schengen Visa | VJC Overseas",
  ...
  estonia: {
    title: "Estonia Schengen Visa | VJC Overseas",
  ...
  greece: {
    title: "Greece Schengen Visa | VJC Overseas",
  ...
  hungary: {
    title: "Hungary Schengen Visa | VJC Overseas",
  ...
  malta: {
    title: "Malta Schengen Visa Process & Requirements",
  ...
  spain: {
    title: "Spain Schengen Visa Process, Documents & Requirements",
