...
const countryVisaData = {
  ...
  "united-kingdom": [
    ...
    { name: "UK business Visa", path: "/migrate/united-kingdom/business-visa" },
    {
      ...
      path: "/migrate/united-kingdom/innovator-visa",
    },
    {
      name: "UK Sponsorship Visa",
      path: "/migrate/united-kingdom/sponsorship-visa",
    },
  ],
  "new-zealand": [
    {
      name: "New Zealand Permanent Resident Visa",
      path: "/migrate/new-zealand/permanent-resident-visa",
    },
    { name: "New Zealand Work Visa", path: "/migrate/new-zealand/work-visa" },
    {
      name: "New Zealand Student Visa",
      path: "/migrate/new-zealand/skilled-work-visa",
    },
    {
      name: "New Zealand Skilled Work Visa",
      path: "/migrate/new-zealand/skilled-work-visa",
    },
    {
      name: "New Zealand Business Visa",
      path: "/migrate/new-zealand/business-visa",
    },
    {
      name: "New Zealand Tourist Visa",
      path: "/migrate/new-zealand/tourist-visa",
    },
    {
      name: "New Zealand Dependent Visa",
      path: "/migrate/new-zealand/dependent-visa",
    },
  ],
  "south-africa": [
    {
      name: "South Africa Critical Skills Visa",
      path: "/migrate/south-africa/critical-skills-visa",
    },
    {
      name: "South Africa General Work Visa",
      path: "/migrate/south-africa/general-work-visa",
    },
    {
      name: "South Africa Business Visa",
      path: "/migrate/south-africa/business-visa",
    },
    {
      name: "South Africa Tourist Visa",
      path: "/migrate/south-africa/tourist-visa",
    },
  ],
  "hong-kong": [
    { name: "Hong Kong Student Visa", path: "/migrate/hong-kong/student-visa" },
    {
      name: "Hong Kong Employment Visa",
      path: "/migrate/hong-kong/employment-visa",
    },
    {
      name: "Hong Kong Business Visa",
      path: "/migrate/hong-kong/business-visa",
    },
    { name: "Hong Kong Tourist Visa", path: "/migrate/hong-kong/tourist-visa" },
    {
      name: "Hong Kong Dependent Visa",
      path: "/migrate/hong-kong/dependent-visa",
    },
  ...
  denmark: [
    ...
    {
      name: "Denmark Work Permit Visa",
      path: "/migrate/denmark/work-permit-visa",
    },
