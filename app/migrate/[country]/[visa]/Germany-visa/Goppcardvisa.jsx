...
const Content = () => {
  ...
  Germany Opportunity Card – Your Gateway to a Bright Future - <span className="text-orange-600">VJC Overseas</span>
  </h3>
</div>
  ...
  <div className="px-4 lg:px-0">
    ...
    <p className="mb-4 text-sm sm:text-base">
      ...
      Germany. The card offers a flexible and faster approach to obtaining a residence permit for work purposes, especially  for those in fields where
...
<p className="hidden lg:block">
  ...
  life in one of the world’s most advanced countries.
      ...
      <h3  className="text-xl font-bold mt-3">Why is the Germany Opportunity Card a Game Changer?</h3>
      ...
      <h3  className="text-xl font-bold mt-3">VJC Overseas – Your Trusted Partner for Success</h3>
