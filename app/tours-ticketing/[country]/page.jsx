...
const metaData = {
  europe: {
    title: "Europe Tour Packages | VJC Overseas",
  ...
  canada: {
    title: "Canada Tour Packages | VJC Overseas",
  ...
  italy: {
    title: "Italy Family Tour Packages | VJC Overseas",
  ...
  turkey: {
    title: "Turkey Tour Packages | VJC Overseas",
  ...
  malaysia: {
    title: "Malaysia Tour Packages & Holiday Deals",
  ...
  greece: {
    title: "Greece Tour Packages | VJC Overseas ",
  ...
  austria: {
    title: "Austria Schengen Visa | VJC Overseas",
