...
const metaData = {
  europe: {
    ...
    description: "Explore Europe tour packages with VJC Overseas. Discover top destinations, customized holiday plans, flight assistance, travel support, and memorable experiences across Europe.",
  ...
  usa: {
    ...
    description: "Explore USA tour packages with VJC Overseas. Discover top attractions, customized holiday plans, travel assistance, flight support, and unforgettable travel experiences across the USA.",
  ...
  australia: {
    ...
    description: "Explore Australia tour packages with VJC Overseas. Discover stunning destinations, customized holiday trips, travel assistance, flight support, and unforgettable experiences across Australia.",
  ...
  canada: {
    ...
    description: "Explore Canada tour packages with VJC Overseas. Discover beautiful destinations, customized holiday plans, travel assistance, flight support, and unforgettable experiences across Canada.",
  ...
  france: {
    ...
    description: "Explore France tour packages with VJC Overseas. Discover iconic landmarks, luxury holidays, customized travel deals, flight assistance, and unforgettable experiences across France.",
  ...
  italy: {
    ...
    description: "Explore Italy family tour packages with VJC Overseas. Enjoy customized family holidays, iconic destinations, travel assistance, flight support, and memorable experiences across Italy.",
  ...
  switzerland: {
   ...
   description: "Discover Switzerland tour packages with VJC Overseas. Explore scenic landscapes, Swiss Alps, customized holiday plans, travel support, and memorable experiences across Switzerland.",
  ...
  dubai: {
    ...
    description: "Explore Dubai tour packages with VJC Overseas. Discover luxury experiences, desert adventures, customized holiday plans, travel assistance, and unforgettable attractions across Dubai.",
  ...
  turkey: {
    ...
    description: "Explore Turkey tour packages with VJC Overseas. Discover historical sites, beautiful landscapes, customized holiday plans, travel assistance, and unforgettable experiences across Turkey",
  ...
  malaysia: {
    ...
    description: "Explore Malaysia tour packages with VJC Overseas. Discover beautiful destinations, customized holiday deals, travel assistance, flight support, and unforgettable experiences in Malaysia.",
  ...
  singapore: {
    ...
    description: "Explore Singapore tour packages with VJC Overseas. Discover top attractions, family holidays, customized travel plans, flight assistance, and unforgettable experiences across Singapore.",
  ...
  greece: {
    ...
    description: "Explore Greece tour packages with VJC Overseas. Discover beautiful islands, historical places, travel experiences, flight assistance, and customized holiday packages for your Greece trip.",
  ...
  bali: {
    ...
    description: "Explore Bali tour packages with VJC Overseas. Discover beautiful beaches, luxury stays, customized holiday plans, travel assistance, and unforgettable experiences across Bali.",
  ...
  andaman: {
    ...
    description: "Explore Andaman tour packages with VJC Overseas. Enjoy beautiful beaches, island adventures, customized holiday trips, travel assistance, and unforgettable experiences in Andaman.",
  ...
  thailand: {
    ...
    description: "Explore Thailand tour packages with VJC Overseas. Discover beaches, islands, cultural attractions, customized holiday trips, travel assistance, and unforgettable experiences in Thailand.",
  ...
  philippines: {
    ...
    description: "Explore Philippines tour packages with VJC Overseas. Discover beautiful islands, beaches, customized holiday plans, travel assistance, and unforgettable experiences across the Philippines.",
  ...
  maldives: {
    ...
    description: "Explore Maldives tour packages with VJC Overseas. Enjoy luxury holidays, beautiful beaches, customized travel plans, resort experiences, and unforgettable island getaways in Maldives.",
  ...
  "fiji-island": {
    ...
    description: "Explore Fiji Island tour packages with VJC Overseas. Enjoy customized holidays, island adventures, travel assistance, flight support, and unforgettable experiences in Fiji.",
  ...
  azerbaijan: {
    ...
    description: "Explore Azerbaijan tour packages with VJC Overseas. Discover stunning landscapes, cultural attractions, customized holidays, travel support, and unforgettable experiences in Azerbaijan.",
  ...
  austria: {
    ...
    description: "Explore Austria tour packages with VJC Overseas. Discover beautiful cities, cultural attractions, customized holiday plans, travel assistance, and unforgettable experiences across Austria.",
  ...
  "south-africa": {
    ...
    description: "Explore South Africa tour packages with VJC Overseas. Experience wildlife safaris, attractions, customized trips, travel assistance, and exciting holiday experiences in South Africa.",
  ...
  japan: {
    ...
    description: "Explore Japan tour packages with VJC Overseas. Discover cultural attractions, beautiful destinations, customized holiday plans, travel assistance, and unforgettable experiences across Japan.",
  ...
  vietnam: {
    ...
    description: "Explore Vietnam tour packages with VJC Overseas. Discover beautiful destinations, cultural experiences, customized holiday plans, travel assistance, and unforgettable trips across Vietnam.",
