...
const metaData = {
  usa: {
    title: "USA Visit Visa Process & Requirements for Indians",
  ...
  canada: {
    title: "Canada Visitor Visa Process & Requirements",
    description: "Apply for Canada Visitor Visa with VJC Overseas. Learn about TRV eligibility, required documents, fees, application process, and travel requirements for visiting Canada with ease.",
  ...
  australia: {
    ...
    description: "Apply for Australia Visitor Visa with VJC Overseas. Learn about tourist and business visa eligibility, required documents, fees, application process, and travel requirements for Australia.",
  ...
  uk: {
    ...
    description: "Apply for UK Visitor Visa with VJC Overseas. Learn about eligibility, required documents, fees, application process, and travel requirements for a smooth UK tourist visa experience.",
  ...
  dubai: {
    ...
    description: "Apply for Dubai visit visa with VJC Overseas. Get complete guidance for tourist and business visas, including eligibility, documents, fees, and application process for UAE travel.",
  ...
  denmark: {
   ...
   description: "Apply for Denmark Visit Visa with VJC Overseas. Learn about eligibility, required documents, fees, application process, and travel requirements for a smooth Denmark tourist visa experience.",
  ...
  austria: {
    ...
    description: "Apply for Austria Visit Visa with VJC Overseas. Learn about eligibility, required documents, fees, application process, and travel requirements for a smooth Austria tourist visa experience.",
  ...
  italy: {
    ...
    description: "Apply for Italy Visit Visa with VJC Overseas. Learn about eligibility, required documents, fees, application process, and travel requirements for a smooth Italy tourist visa experience.",
  ...
  schengen: {
    title: "Schengen Visit Visa Process & Requirements",
    description:  "Apply for Schengen Visit Visa with VJC Overseas. Learn about eligibility, required documents, fees, application process, and travel requirements for visiting Schengen countries with ease.",
