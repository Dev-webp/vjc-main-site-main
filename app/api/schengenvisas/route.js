...
export async function POST(req) {
  try {
    ...
    const insertedVisa = db.prepare("SELECT * FROM schengenvisas WHERE id = ?").get(result.lastInsertRowid);
...
export async function PUT(req) {
  try {
    ...
    const updatedVisa = db.prepare("SELECT * FROM schengenvisas WHERE id = ?").get(visa.id);
...
export async function DELETE(req) {
  try {
    ...
    const stmt = db.prepare("DELETE FROM schengenvisas WHERE id = ?");
