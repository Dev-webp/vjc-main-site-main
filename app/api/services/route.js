...
export async function POST(req) {
  try {
    ...
    const insertedVisa = db.prepare("SELECT * FROM services WHERE id = ?").get(result.lastInsertRowid);
...
export async function PUT(req) {
  try {
    ...
    const updatedVisa = db.prepare("SELECT * FROM services WHERE id = ?").get(visa.id);
