...
export async function POST(req) {
  try {
    ...
    const insertedVisa = db.prepare("SELECT * FROM tours WHERE id = ?").get(result.lastInsertRowid);
...
export async function PUT(req) {
  try {
    ...
    const updatedVisa = db.prepare("SELECT * FROM tours WHERE id = ?").get(visa.id);
