        ...
        <React.Fragment key={item.name}>
          {item.name === "Study Abroad" ? (
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-3 invisible opacity-0 group-hover:visible group-hover:opacity-100 hover:visible hover:opacity-100 grid grid-cols-5 grid-rows-4 gap-2 bg-gradient-to-br from-orange-500/60 to-black bg-opacity-50 p-3 w-[700px] min-h-[200px] shadow-xl z-50  transition-all duration-300 ease-in-out">
            ...
            <div className="relative group">
              ...
              {["Migrate To", "PR Visas"].includes(item.name) && (
                <div className="absolute left-0 top-full mt-3 invisible opacity-0 group-hover:visible group-hover:opacity-100 hover:visible hover:opacity-100 flex flex-col space-y-2 bg-gradient-to-br from-orange-500/60 to-black bg-opacity-50 p-3 shadow-xl z-50 transition-all duration-300 ease-in-out">
