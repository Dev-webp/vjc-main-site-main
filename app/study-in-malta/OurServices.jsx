...
export default function WhyStudyMalta() {
  ...
  return (
    <section className="bg-white pt-0 pb-0 px-4 lg:px-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-semibold text-blue-900 -mt-14 mb-3">Why Study in Malta</h3>
...
<Link href="/contact-us">
  <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-full text-lg font-semibold shadow-md transition">
