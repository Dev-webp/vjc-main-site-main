    ...
    <>
      <div className=" bg-orange-100">
        <div
          ...
          style={{
            backgroundImage: `url('/canadabgimg3.png')`,
        ...
        >
          ...
          <section className="relative p-8 max-w-6xl mx-auto mb-4">
            <h2 className="text-[2.50rem] font-bold text-center text-white uppercase">
              <span className="text-saffron text-[2.70rem]">Step-By-Step Guide</span> <br /> to Applying for Canada Permanent Residency
            </h2>
