...
export default function GermanyInvestorVisa() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 -mt-10 font-[Times_New_Roman]">
    <h1 className="flex justify-center text-xl sm:text-2xl md:text-2xl font-bold mb-8 text-center">Germany Investor Visa: Your Pathway to European Business Success</h1>
        <p className="mb-6">Unlock the doors to business and investment opportunities in Europe with the Germany Investor Visa. This visa offers an exclusive chance for non-EU nationals to establish and manage a business in Germany, one of the world’s leading economies. Whether you are looking to expand your global reach or embark on a new entrepreneurial journey, the Germany Investor Visa is the ideal route for investors seeking to grow their assets in the heart of Europe.</p>
     

      <div className="mb-8 md:flex gap-6">
        <div className="md:w-1/2">
          <h2 className="text-2xl font-semibold mb-2">🇩🇪 What is the Germany Investor Visa?</h2>
          <p className="mb-4">The Germany Investor Visa is a residency permit designed for foreign nationals who wish to invest in the German economy through the establishment of a business or investment in an existing company. The visa provides an opportunity to live, work, and run a business in Germany while contributing to the country's economic growth. It is also a gateway for securing permanent residence or citizenship after fulfilling the required conditions over time.</p>
      ...
      <div>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>Health Insurance: Mandatory for the duration of stay.</li>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>Residence Application Form</li>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>High-Quality Infrastructure and Support</li>
          <li>Family Visa Option</li>
