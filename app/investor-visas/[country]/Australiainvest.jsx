...
export default function AustraliaInvestorVisa() {
  return (
    ...
    <h1 className="flex justify-center text-xl sm:text-2xl md:text-2xl font-bold mb-8 text-center">Australia Investor Visa – Your Gateway to Successful Investment and Business Opportunities</h1>
        <p className="mb-6">Welcome to <span className="text-orange-500">VJC Overseas</span>! If you're looking to invest in Australia and enjoy the benefits of living in one of the world's most economically stable and business-friendly countries, the Australia Investor Visa could be your perfect pathway.</p>
      

      <div className="mb-8 flex flex-col md:flex-row gap-6 items-center">
        <div className="md:w-2/3">
          <h2 className="text-2xl font-semibold mb-2"> What is the Australia Investor Visa?</h2>
          <p className="mb-4">The Australia Investor Visa is designed for high-net-worth individuals interested in making significant investments in the Australian economy. It includes:</p>
          <ul className="list-disc list-inside mb-4">
            <li>🇦🇺 Subclass 188 Investor Visa (Temporary)</li>
            <li>🇦🇺 Subclass 888 Investor Visa (Permanent)</li>
          </ul>
          <p>The Subclass 188 visa allows you to live in Australia temporarily and manage investments, with a pathway to the Subclass 888 Permanent Resident Visa.</p>
        </div>
      ...
      <div className="mb-8">
        <h2 className="text-xl font-semibold mt-4 mb-2"> Eligibility for the Australia Investor Visa</h2>
        <ul className="list-disc list-inside mb-4">
      ...
      <div className="mb-8">
        <h2 className="text-xl mt-4 font-semibold mb-2"> Key Documents for the Australia Investor Visa</h2>
        <ul className="list-disc list-inside mb-4">
        ...
        <p><span className="text-orange-500">VJC Overseas</span> will assist in compiling these documents for a successful application.</p>
      </div>
      ...
      <div>
        ...
        <p className="mb-4">With <span className="text-orange-500">VJC Overseas</span> by your side, investing in Australia is easier and more efficient. Take the first step toward a prosperous future — contact us for your consultation now!</p>
        <p className="italic"> Your dream, our direction – <span className="text-orange-500">VJC Overseas</span>.</p>
      </div>
    </div>
  );
}
