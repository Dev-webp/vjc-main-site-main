...
const metaData = {
  usa: {
    title: "Study in USA Universities, Courses & Student Visa Guide",
  ...
  uk: {
    title: " Study in UK Requirements & Visa Guide",
  ...
  germany: {
    title: "Study in Germany Universities & Student Visa",
  ...
  italy: {
    title: "Study in Italy Universities & Student Visa Guide",
  ...
  newzealand: {
    title: "Study in New Zealand Universities & Student Visa",
  ...
  hongkong: {
    title: "Study in Hong Kong Requirements & Visa Guide",
  ...
  norway: {
    title: "Study in Norway Hyderabad | VJC Overseas",
  ...
  netherlands: {
    title: "Study in Netherlands Universities & Visa",
